...
<embedex source="examples/quickstart/welcomeEmailJob.ts">
...
<embedex source="examples/quickstart/jobsRegistry.ts">
...
<embedex source="examples/quickstart/enqueueJob.ts">
...
<embedex source="examples/quickstart/startWorker.ts">
...
<embedex source="examples/usage/myJob.ts">
...
export class MyJob implements HandlerInterface<MyJobData> {
  ...
  public async perform(data: MyJobData, job?: BackgroundJobType<MyJobData>) {
    // Job implementation
...
<embedex source="examples/usage/registerJobs.ts">
...
<embedex source="examples/usage/registerJobsWithDependencies.ts">
...
<embedex source="examples/usage/jobs/emailServiceJob.ts">
...
<embedex source="examples/usage/enqueueBasic.ts">
...
<embedex source="examples/usage/enqueueWithOptions.ts">
...
<embedex source="examples/usage/enqueueByName.ts">
...
<embedex source="examples/usage/startWorkerBasic.ts">
...
<embedex source="examples/usage/startWorkerWithOptions.ts">
...
<embedex source="examples/usage/stopWorker.ts">
...
<embedex source="examples/usage/cronRegister.ts">
...
<embedex source="examples/usage/cronRemove.ts">
...
<embedex source="examples/usage/uniqueSimple.ts">
...
<embedex source="examples/usage/uniqueAdvanced.ts">
...
<embedex source="examples/usage/uniqueMultipleEnqueued.ts">
